<template>
    <div class="row w-100 h-100">
        <div class="m-auto align-self-center" style="height: 700px; background-color: red; width: 500px; ">
            ...
            <form>
                ...
                <button class="btn btn-primary w-100 py-2 fw-bold" type="submit" style="background-color: #012060">로그인</button>
            </form>

            <div class="d-sm-flex my-3 w-100"><p class="m-auto fw-bold" style="color: #FF0000">로그인 정보를 다시 확인해주세요</p></div>

            <div class="d-sm-flex my-3 w-100">
            ...
            <div class="d-sm-flex my-5 m-auto w-100">
                <div><a href="https://nid.naver.com/nidlogin.login?mode=form&url=https://www.naver.com/"><img :src="require('@/assets/btnG_축약형.png')" class="w-75"></a></div>
                <div><a href="https://nid.naver.com/nidlogin.login?mode=form&url=https://www.naver.com/"><img :src="require('@/assets/btnG_축약형.png')" class="w-75"></a></div>
                <div><a href="https://nid.naver.com/nidlogin.login?mode=form&url=https://www.naver.com/"><img :src="require('@/assets/btnG_축약형.png')" class="w-75"></a></div>
            </div>
