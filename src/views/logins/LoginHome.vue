<template>
  <div class="mt-4">
    ...
    <div class="w100">
      ...
      <button class="btn btn-primary w100 py-2 fw-bold" type="submit" style="background-color: #012060"
              @click="submitLoginInfo">로그인
      </button>
    </div>
    ...
    <div class="d-sm-flex my-5 m-auto w100">
      <div class="m-auto w25"><img @click="$router.push('/social-join')" class="w100"
                                   :src="require('@/assets/images/btnG_축약형.png')"></div>
      <div class="m-auto w25"><img @click="$router.push('/social-join')" class="w100"
                                   :src="require('@/assets/images/btnG_축약형.png')"></div>
      <div class="m-auto w25"><img @click="$router.push('/social-join')" class="w100"
                                   :src="require('@/assets/images/btnG_축약형.png')"></div>
