<template>
    ...
    <div class="vw100 vh100 d-sm-flex ">
        ...
        <div class="sidebar vw5 vh100" style="background-color: #012060">
            <div class="vh75 row align-self-center justify-content-center mt-5">
                <div class="text-center">
                    <router-link to="/main" class="d-sm-flex justify-content-center align-items-center zoom" style="color:white">
                        <img :src="require('@/assets/images/home.png')" class="m-auto" style="width: 1.5vw; height: 1.5vw; filter: invert()">
                ...
                <div class="text-center">
                    <router-link to="/group" class="d-sm-flex justify-content-center align-items-center zoom" style="color:white">
                ...
                <div class="text-center">
                    <router-link to="/chat" class="d-sm-flex justify-content-center align-items-center zoom" style="color:white">
                ...
                <div class="text-center">
                    <router-link to="/star" class="d-sm-flex justify-content-center align-items-center zoom" style="color:white">
                ...
                <div class="text-center">
                    <router-link to="/rank" class="d-sm-flex justify-content-center align-items-center zoom" style="color:white">
                        <img :src="require('@/assets/images/ranking_fill.png')" class="m-auto" style="width: 1.5vw; height: 1.5vw; filter: invert()">
        ...
        <!-- sidebar detail -->
        <div class="vw20 vh100" style="background-color: #EEEEEE">
            <div class="w-100 vh5 p-3">
                <div class="d-sm-flex justify-content-between align-items-center w-100 h-100">
                    <router-link to="/main"><img :src="require('@/assets/images/return.png')" class="m-auto" style="width: 1.1vw; height: 1.1vw; filter: invert(84%) sepia(1%) saturate(15%) hue-rotate(314deg) brightness(98%) contrast(96%);"></router-link>
                    <router-link to="/main"><img :src="require('@/assets/images/close.png')" class="m-auto" style="width: 1.1vw; height: 1.1vw; filter: invert(84%) sepia(1%) saturate(15%) hue-rotate(314deg) brightness(98%) contrast(96%);"></router-link>
                </div>
            </div>
            ...
            <div class="w-100 vh20" style="background-color: gray">아</div>
            <div class="w-100 vh20" style="background-color: lightgray">아</div>
        </div>
